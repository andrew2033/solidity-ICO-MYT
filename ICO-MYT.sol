...
contract MytriICO is Mytri{
    address public admin;
    address payable public deposit;
    uint tokenPrice = 0.001 ether;  // 1 ETH = 1000 MYT, 1 CRPT = 0.001
   ...
   receive () payable external{
    ...
    function transfer(address to, uint tokens) public override returns (bool success){
        ...
        super.transfer(to, tokens);  // same as Mytri.transfer(to, tokens);
        return true;
    }
    ...
    function transferFrom(address from, address to, uint tokens) public override returns (bool success){
        ...
        Mytri.transferFrom(from, to, tokens);  // same as super.transferFrom(to, tokens);
        return true;
